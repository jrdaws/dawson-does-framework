    ...
    <Card className={cn("border-slate-200", className)}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          {description && (
            <p className="text-sm text-slate-600 line-clamp-2 bg-slate-50 p-2 rounded-md">
              {description}
            </p>
          )}
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-slate-50 rounded-lg p-3 border border-slate-100">
            ...
            <p className="font-medium text-slate-800 capitalize">{template}</p>
          </div>
          ...
          <div className="bg-slate-50 rounded-lg p-3 border border-slate-100">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-slate-500">Est. Setup</span>
            </div>
        ...
        {topFeatures.length > 0 && (
          <div>
            <h4 className="text-xs text-slate-500 mb-2">Selected Features</h4>
        ...
        {activeIntegrations.length > 0 && (
          <div>
            <h4 className="text-xs text-slate-500 mb-2">Active Integrations</h4>
            <div className="flex flex-wrap gap-1">
