...
export function Footer({
  ...
  description = "Building the future of web development, one project at a time.",
          ...
          <div className="py-8 border-t border-slate-800">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div>
                ...
                <p className="text-slate-400 text-sm">Get the latest updates and news</p>
              </div>
              <form className="flex gap-2 w-full md:w-auto">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="flex-1 md:w-64 px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-orange-500"
                />
                <button
                  type="submit"
